...
namespace DustInTheWind.ClockNet.Core.Shapes.Basic
{
    ...
    public class RectangleHand : VectorialHandBase
    {
        /// <summary>
        /// The default name for the Shape.
        /// </summary>
        public const string DefaultName = "Rectangle Hand";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RectangleHand"/> class with
        /// default values.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RectangleHand"/> class.
        /// </summary>
        ...
        public RectangleHand(Color fillColor, float height)
        ...
        public RectangleHand(RectangleF rectangle, Color outlineColor, Color fillColor, float height, float lineWidth)
